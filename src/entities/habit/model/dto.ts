...
export const HABIT_GOAL_METRIC_VALUES: readonly HabitGoalMetric[] = ["checkins", "value"];

export const HABIT_GOAL_PERIOD_VALUES: readonly HabitGoalPeriod[] = ["day", "week", "month"];
